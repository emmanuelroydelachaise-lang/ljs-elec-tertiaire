const CACHE = 'ljs-elec-tertiaire-v7';
const ASSETS = [
  './', './index.html', './styles.css', './print-vector.css', './print-fit.css', './admin-archives.css', './admin-dashboard.css', './technician-admin-changes.css', './technician-archives.css', './leave-requests.css', './admin-leave-requests.css', './config.js', './elec-tertiaire-supabase-router.js', './hidden-admin-access.js',
